window.onload = function () {
    ...
    const addQuestionnaireContainer = document.getElementById('add-questionnaire-container');
    ...
    if (ListContainer.children.length === 0) {
        ...
        // 添加居中样式
        addQuestionnaireContainer.style.display = 'block';
    }

    if (ListContainer.children.length > 0) {
        addQuestionnaireContainer.style.display = 'block';
    } else {
        addQuestionnaireContainer.style.display = 'none';
    }
    if (ListContainer.children.length > 0) {
